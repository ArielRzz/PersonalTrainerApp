...
<div class="container-sm px-5 pt-5 mb-4">
    <div class="container-sm px-5 pt-5 mb-5">
        ...
        <div class="card card-shadow border-0 mb-4 ">
            ...
            <div class="p-3">
                ...
                <ul class="list-inline font-14 mt-3">
                    ...
                    <%--<li class="py-1"><i class="icon-check text-success"></i> ${plan.tipoDeModalidad}</li>--%>
                ...
                <div class="d-flex mt-3 align-items-center">
                    <h2 class="price">${plan.precio}<small>/arg</small></h2>
                    <button type="button" class="btn btn-primary"><a style="color: white" href="seleccionarPlan/${plan.id}">Seleccionar</a></button>
                </div>
            </div>
        </div>
    <!-- Column -->
